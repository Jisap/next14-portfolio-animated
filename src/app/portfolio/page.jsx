...
const PortfolioPage = () => {
  ...
  const x = useTransform(scrollYProgress, [0, 1], ["0%", "-80%"]); // permite crear una relación de mapeo entre dos rangos de valores
  // Conforme cambia y de 0 a 1, x cambiara de 0% a -80%   
  return (
    <motion.div
      className="h-full"
      initial={{ y: "-200vh" }}
    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">  
          <motion.div
            style={{ x }}  // El avance del scroll en y se traslada al eje x
            className="flex"
          >
